...
//=========Question 1==================================
	...
	void TestQ1_two_strings_2(CuTest *tc) {

		CuAssertStrEquals(tc, "Thelabishard!", my_strcat("Thelab","ishard!"));
	}

	void TestQ1_second_empty_2(CuTest *tc) {

		CuAssertStrEquals(tc, "Thelab", my_strcat("Thelab",""));
	}
	void TestQ1_first_empty_2(CuTest *tc) {

		CuAssertStrEquals(tc, "ishard!", my_strcat("","ishard!"));
	}
...
//=================Question 2================================
	...
	void TestQ2_find_notThere1(CuTest *tc) {
		...
		int expected = -1;
		int actual = find(4201,Clist,size);
	...
	void TestQ2_find_There1(CuTest *tc) {
		...
		int expected = 0;
		int actual = find(1200,Clist,size);
	...
	void TestQ2_inputGradesAndCalculateFinal_other(CuTest *tc) {


		char inputFile[] =  "teststudents.txt";
		char gradesFile[] =  "testgrades.txt";
		int size;
		//create list using the input file
		student **Clist = create_class_list(inputFile,&size);
		//input grades using the grades input file
		...
		compute_final_course_grades(Clist,size);
		//Output final course marks
		output_final_course_grades("testoutputGrades.txt",Clist,size);

		//now we open the golden file with the written file and compare line by line

		char actualFile[] =  "testoutputGrades.txt";
		char goldenFile[] =  "testoutput.txt";
	...
	void TestQ2_withdraw_idNo_No(CuTest *tc) {
		...
		int idNo1=4904;
		//create list using the input file
		student **actualList = create_class_list(inputFile,&size);
		input_grades(gradesFile,actualList,size);
		withdraw(idNo1,actualList, &size);

	}
	void TestQ2_withdraw_idNo1(CuTest *tc) {


		char inputFile[] =  "teststudents.txt";
		char gradesFile[] =  "testgrades.txt";
		char input2File[] = "testforwithdraw.txt";
		char grades2File[] =  "withdrawgrade.txt";
		int size;
		int size2;
		int i;
		int idNo1=4903;
		...
		student **actualList = create_class_list(inputFile,&size);
		input_grades(gradesFile,actualList,size);
		compute_final_course_grades(actualList,size);
		withdraw(idNo1,actualList, &size);
		student **expectedList=create_class_list(input2File,&size2);
		input_grades(grades2File,expectedList,size2);
		compute_final_course_grades(expectedList,size2);
		for (i=0;i<size;i++){
...
//=================Question 3================================  
	void TestQ3_readandSort1(CuTest *tc) {
		...
		void TestQ3_readandSort1_other(CuTest *tc) {

			char inputFile[] =  "testwordlist.txt";
			int size;
			//create list using the input file
			char **actualList = read_words(inputFile,&size);
			sort_words(actualList,size);

			char *expectedList[]={"cheers","civil","elective","what","why"};
	...
	void TestQ3_readandSort2_other(CuTest *tc) {
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_two_strings_2);
		SUITE_ADD_TEST(suite, TestQ1_second_empty_2);
		SUITE_ADD_TEST(suite, TestQ1_first_empty_2);

		SUITE_ADD_TEST(suite, TestQ2_find_notThere);
		SUITE_ADD_TEST(suite, TestQ2_find_notThere1);
		SUITE_ADD_TEST(suite, TestQ2_find_There);
		SUITE_ADD_TEST(suite, TestQ2_find_There1);
		SUITE_ADD_TEST(suite, TestQ2_inputGradesAndCalculateFinal);
		SUITE_ADD_TEST(suite, TestQ2_inputGradesAndCalculateFinal_other);
		SUITE_ADD_TEST(suite, TestQ2_withdraw_idNo_No);
		SUITE_ADD_TEST(suite, TestQ2_withdraw_idNo1);


		SUITE_ADD_TEST(suite, TestQ3_readandSort1);
		SUITE_ADD_TEST(suite, TestQ3_readandSort1_other);
		SUITE_ADD_TEST(suite, TestQ3_readandSort2);
		SUITE_ADD_TEST(suite, TestQ3_readandSort2_other);
